...
CC=g++
INC=
CFLAGS=-Wall -Werror -Wextra -Wshadow -pedantic -Ofast -std=gnu++11 -fomit-frame-pointer -mavx2 -msse4 -march=native -mfma -flto
CCLIBS=
LDFLAGS=-Wall -Werror -Wextra -Wshadow -pedantic -Ofast -std=gnu++11 -fomit-frame-pointer -mavx2 -msse4 -march=native -mfma -flto
